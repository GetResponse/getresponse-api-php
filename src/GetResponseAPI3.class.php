...
class GetResponse
{
	...
	/**
	 * retrieving contacts in campaign by params
	 * @param string $campaign_id
	 * @param array $params
	 * @return mixed
	 */
	public function getCampaignContacts($campaign_id, $params = array())
	{
		return $this->call('campaigns/'.$campaign_id.'/contacts', 'GET', $params);
	}
	...
	{
		return $this->call('search-contacts', 'GET', $params);
	}
	...
	{
		return $this->call('contacts', 'GET', $params);
	}
	...
	{
		return $this->call('custom-fields', 'GET', $params);
	}
	...
	{
		return $this->call('webforms', 'GET', $params);
	}
	...
	{
		return $this->call('forms', 'GET', $params);
	}
